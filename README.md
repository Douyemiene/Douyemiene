...
**SurfGI-GS** replaces volumetric 3D Gaussian primitives with surface-aligned 2D Gaussian surfels, fixing the geometric inconsistencies that corrupt deferred shading pipelines and path-traced indirect illumination.
